...
<div class="dropdown">
  <ul class="dropdown-menu">
    <?php if (isset($_SESSION['username'])) : ?>
        ...
        <a class="btn btn-primary" role="button" style="border: 1px white;color: black; background: white;border-radius: 20px;font-family: 'Bebas Neue', serif;font-size: 23px;" href="edit_profile.php">Edit Profile</a>
    
      <li>
                            <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="get">
                            <button href="homepage.php" class="btn btn-light submit-button" type="submit" name="logout" value="Logout" style="background: white;border-radius: 20px;font-family: 'Bebas Neue', serif;font-size: 23px;">LOGOUT</button>
                         </form>
                        </li>
    <?php endif; ?>
  </ul>
      ...
      dropdownMenu.classList.remove('show');
                    ...
                    <div class="collapse navbar-collapse d-md-flex d-lg-flex d-xl-flex d-xxl-flex justify-content-md-end justify-content-lg-end justify-content-xl-end justify-content-xxl-end" id="navcol-1">
                        ...
                        <ul class="navbar-nav ml-auto">
                            <li class="nav-item"><a class="nav-link" href="dashboard.php" style="font-size: 21PX;font-family: 'Bebas Neue', serif;">dashboard</a></li>
